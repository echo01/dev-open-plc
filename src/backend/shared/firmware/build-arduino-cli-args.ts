...
export interface BuildArduinoCliCompileArgsOptions {
  ...
  /** Additional Arduino library roots supplied by a board package. */
  localLibraryPaths?: readonly string[]
  /**
...
export function buildArduinoCliCompileArgs(
  ...
  if (options.localLibraryPaths) {
    for (const localLibraryPath of options.localLibraryPaths) {
      args.push('--library', localLibraryPath)
    }
  }
